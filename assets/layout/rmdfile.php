...
Factory::getDocument()->getWebAssetManager()
  ->registerScript(
    'return-template',
    'media/plg_user_changetemplate/js/return-template.js',
...
?>
<return-template label-text="Return Template" button-text="Return Template" token="<?= Session::getFormToken(); ?>">
  <button id="returnbutt"></button>
</return-template>
